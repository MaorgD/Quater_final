    ...
    render() {
        if (counter == -1) {
            ...
            div.innerHTML =
                `
            <div>
            <h4 class="display-5 text-center">Welcome To Trivia Game
            </h4>
            </div>
    
            <div class="d-flex flex-column justify-content-center align-items-center h-100">
            <div >
            <button class="btn btn-secondary play">Start to play</button>
            </div>
            ...
            this.answers.forEach((answer, i) => {
                ...
                btn.className = 'btn btn-secondary col-8 mt-2 '
